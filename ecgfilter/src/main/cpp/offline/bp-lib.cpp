...
Java_com_viatom_lib_duoek_utils_Bp2FilterUtil_shortfilter(JNIEnv *env, jclass clazz, jshortArray inShorts) {
...
//Java_com_viatom_lib_duoek_activity_HomeActivity_offlineFilter(JNIEnv *env, jobject thiz, jdoubleArray doubles) {
//
//    double *doubleArray;
