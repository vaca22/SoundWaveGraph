...
/**********************************************************
// Function：GetExtendedR
// Description：数据扩展，本算法主要为了扩展滤波器长度
**********************************************************/
